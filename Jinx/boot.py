...
from Jinx.activity import Activity
from Jinx.virtual_assistant import VirtualAssistant
from Jinx.EventDispatcher.event_dispatcher import EventDispatcher
from Jinx.TextManager.text_manager import TextManager
from Jinx.configurer import config
from Jinx.updater import Updater
...
class Boot:
    ...
    def initiate(self):
        print("Jinx is on and loading, wait for the beep sound to give your command.")
