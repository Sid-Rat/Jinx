from Jinx.Modules.base_module import BaseModule
from Jinx.local_libs.wolframalpha_speech.index import WolframalphaSpeech
from Jinx.local_libs.wolframalpha_speech.exceptions_manager import *
